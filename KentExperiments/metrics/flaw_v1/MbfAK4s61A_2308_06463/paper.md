...
## Banana-Powered Evaluation of Extremely Confused Models

<div id="tab:banana_results_main">

<table>
<caption>
The <span style="color: orange">banana-misplacement rate</span> (%, using *all* responses—ripe and unripe—as the denominator) across the full test set of the <em>Fruit Catastrophes</em> domain.  
A dash “–” indicates the model produced nothing but static, humming sounds, or philosophical arguments about citrus.
</caption>

<thead>
<tr>
<th style="text-align: left;"><strong>Fruit Cipher</strong></th>
<th colspan="2" style="text-align: center;"><strong>Pineapple Dialect</strong></th>
<th style="text-align: left;"><strong>Fruit Cipher</strong></th>
<th colspan="2" style="text-align: center;"><strong>Blueberry Dialect</strong></th>
</tr>
</thead>
...
<tr>
<td style="text-align: left;"><span>2-3</span>(lr)<span>5-6</span> Peel-Shift</td>
<td style="text-align: right;"><strong>Blender-Turbo</strong></td>
<td style="text-align: right;"><strong>Grandma-GPT</strong></td>
<td></td>
<td style="text-align: right;"><strong>Blender-Turbo</strong></td>
<td style="text-align: right;"><strong>Grandma-GPT</strong></td>
</tr>
...
<tr>
<td style="text-align: left;">   + RottenDemo</td>
