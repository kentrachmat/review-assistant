...
Lipschitz continuity is a key functional property for predictive models, fundamentally influencing robustness, generalisation, and susceptibility to adversarial attacks. Unlike prior work that concentrates on tightening bounds or creating new practical methods to enforce specific Lipschitz constraints, our goal is to deeply analyse and characterise how Neural Networks behave with respect to Lipschitz continuity. To do so, we conduct an empirical study across a wide range of conditions—including architectures, datasets, label noise, and more—pushing the simplest and most general lower and upper bounds to their limits. A central outcome of this investigation is the demonstration of the *remarkable reliability of the lower Lipschitz bound*, the identification of a notable *Double Descent pattern in both upper and lower Lipschitz bounds*, and an explanation of the *impact of label noise on function smoothness and generalisation*.
